...
export class EventUserID1755879966589 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "events" ADD "userId" character varying(255) UNIQUE NOT NULL`);
        await queryRunner.query(`ALTER TABLE "customers" DROP COLUMN "userId"`);
        await queryRunner.query(`ALTER TABLE "customers" ADD "userId" character varying(255) UNIQUE NOT NULL`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_customers_userId2" ON "customers" ("userId")`);
